...
namespace Redox.API.Plugins
{
    public sealed class PluginCollector
    {
        ...
        {
            PluginEngineManager.LoadPlugin(dirName);
        }
        /// <summary>
        ...
        public void UnloadPlugin(string Title)
        {
            ...
            {
                PluginEngineManager.UnloadPlugin(Title, container);
            }
        ...
        public void ReloadPlugin(string Title)
        {
            ...
            if (container != null)
            {
                if (container.Running)
                    PluginEngineManager.ReloadPlugin(Title);
            }
        }
        /// <summary>
        /// Unloads all plugins
        ...
        {
            PluginEngineManager.UnloadAllPlugins();
        }
        /// <summary>
        /// Reloads all plugins
        /// </summary>
        ...
        {
            PluginEngineManager.ReloadAllPlugins();
        }
        /// <summary>
